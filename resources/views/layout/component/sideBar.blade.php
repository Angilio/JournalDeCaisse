<ul id="sideBar">
    <li><a href="{{ route('dashboard.dashboard.index')}}" class="mt-2 fw-bold mb-4 d-flex gap-4 align-items-center {{ request()->routeIs('dashboard.dashboard.index') ? 'active' : '' }}"><i class="fa-solid fa-house-chimney"></i> Dashbord</a></li>
    <li><a href="{{ route('sortie.sortie.index') }}" class="mb-4 fw-bold d-flex gap-4 align-items-center {{ request()->is('entre/entre*') || request()->is('sortie/sortie*') ? 'active' : '' }}"><i class="fa-solid fa-walkie-talkie"></i> Opération</a></li>
