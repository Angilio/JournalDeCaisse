<ul id="sideBar">
    <li><a href="{{route('dashboard')}}" class="mt-2 fw-bold mb-4 d-flex gap-4 align-items-center @if(request()->route()->getName() == 'dashboard') active @endif" ><i class="fa-solid fa-house-chimney"></i> Dashbord</a></li>
